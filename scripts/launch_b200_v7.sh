#!/usr/bin/env bash
# v7 = v6 at lr 1e-5 — the midpoint of the lr scan (5e-6 stable/slow at v4, 2e-5 fast/
# collapse-prone; v6 tests 2e-5+penalty, v7 tests 1e-5+penalty),
...
export MS_LR=1e-5            # midpoint of the lr scan; overlong penalty on
...
# v7 dosing (same as v6): EVERY row starts BARE (r=0); no mechanical dose moves at all (the old
