...
#   bash scripts/launch_b200_v9.sh teacher
#
# Everything else is derived below; edit the "site" block if your paths differ.
set -eu
ARM=${1:?usage: launch_b200_v9.sh teacher|static [n_cycles]}; CYCLES=${2:-50}
...
# ---- experiment (v4) ---------------------------------------------------------------
export MS_EXP=questa_${ARM}_v9 MS_WORK=$MS_ROOT/runs/${ARM}_v9 MS_WANDB_RUN_ID=questa_${ARM}_v9
